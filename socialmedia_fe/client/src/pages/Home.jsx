  ...
  return (
    <>
      <div className='w-full px-0 lg:px-0 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden'>
        ...
        <div className='w-full px-4 flex gap-2 lg:gap-4 pt-5 pb-10 h-full'>
          {/* LEFT */}
                ...
                <div>
                  {posting ? (
                    ...
                    <CustomButton
                      type='submit'
                      title='Post'
                      containerStyles='bg-customOrange text-white py-1 px-6 rounded-full font-semibold text-sm'
                    />
                  )}
                </div>
